...
[![Build Status](https://travis-ci.org/devise-security/devise-security.svg?branch=main)](https://travis-ci.org/devise-security/devise-security)
[![Coverage Status](https://coveralls.io/repos/github/devise-security/devise-security/badge.svg?branch=main)](https://coveralls.io/github/devise-security/devise-security?branch=main)
